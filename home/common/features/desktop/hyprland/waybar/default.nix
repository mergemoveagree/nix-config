...
in {
  ...
  programs.waybar = {
    ...
    settings.mainBar = {
      ...
      modules-right = ["custom/padd" "custom/l_end" "group/expand" "network" "group/expand-3" "group/expand-2" "idle_inhibitor" "memory" "cpu" "power-profiles-daemon" "custom/cputemp" "battery" "clock" "custom/notification" "custom/padd"];
